...
namespace WindowsFormsTeplovoz
{
    ...
    {
        protected readonly int teploWidth = 140;
        protected readonly int teploHeight = 45;
        ...
        protected Lokomotiv(int maxSpeed, float weight, Color mainColor, int TeploWidth, int TeploHeight)
        {
            MaxSpeed = maxSpeed;
            Weight = weight;
            MainColor = mainColor;
        ...
        public override void MoveTeplo(Direction direction)
        {
