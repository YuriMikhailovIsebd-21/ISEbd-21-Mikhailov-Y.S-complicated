...
namespace WindowsFormsTeplovoz
{
    class Teplovoz
    {
        ...
        private readonly int TeploWidth = 140;

        private readonly int TeploHeight = 45;
        ...
        public void Init(Color mainColor, Color windowColor, bool windows, Color dopColor, bool doorTeplo,  bool tubeTeplo, int tube)
        {
            MainColor = mainColor;
        ...
        public void DrawTeplo(Graphics g)
        {
            ...
            if (TubeTeplo)
            {
                ...
                Dop.DrawTube(g, brush, _startPosX, _startPosY);
            }
